...
public class CandidatureService {
    ...
    public CandidatureService() { this.candidatureDAO = new CandidatureDAO();
    }

    public boolean iscrizioneAnnuncio(Candidature candidatura) {return this.candidatureDAO.iscrizioneAnnuncio(candidatura);}
