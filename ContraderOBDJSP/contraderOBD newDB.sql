DROP DATABASE contraderproject1;

CREATE DATABASE contraderproject1;

USE contraderproject1;
...
INSERT INTO driver VALUES (1,'Antonio','Rossi', 'email@email.it', '', 'ASDFA230AAFRWE4R','Napoli', NULL),
							(2,'Pippo','Demagistris', 'email@email.it', '','SLONGBLONGSERADM','Torino', NULL),
							(3,'Carmine','Albero', 'email@email.it', '','RSSDFETEADFTSFDF','Modena', NULL),
                            (4,'Alessia','Bardo', 'email@email.it', '','NGRONDNRONGGUNR','Benevento', NULL),
                            (5,'Ginevra','Luce', 'email@email.it', '','GRUNCGRRUNCGRUNC','Roma', NULL);
...
INSERT INTO automobile VALUES	(1,'AS123PC',3421343,'FORD','FIESTA','DIESEL','UTILITARIA','A','a_01','18/04/17','17/02/18',32000,NULL,1),
								(2,'AS123MN',342135452,'FIAT','PANDA','DIESEL','UTILITARIA','M','a_01','18/04/17','17/02/18',6000,NULL,1),
                                (3,'AS654PC',125642,'FIAT','PUNTO','DIESEL','COMMERCIALE','M','a_02','10/04/16','17/02/18',3200,1,1),
                                (4,'FG050588',213465321,'FERRARI','F430','DIESEL','COMMERCIALE','A','a_03','18/04/17','17/02/18',3200,1,1),
                                (5,'FE643DE',8346743,'NISSAN','QASHQAI','DIESEL','SUV','M','a_02','02/10/17','12/12/17',3200,1,1),
                                (6,'AA832DB',685436081,'VOLKSWAGEN','POLO','BENZINA','UTILITARIA','M','a_02','02/02/18','17/03/18',3200,1,1);
