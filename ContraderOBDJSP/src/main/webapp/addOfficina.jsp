                    ...
                    <div class="col-lg-9">
                        ...
                        if (status.equals("success")) { %>
                            <div class="alert alert-success alert-dismissable">
                                ...
                                Officina inserita con successo
                            </div>
                            <% } else if (status.equals("error")) { %>
                                <div class="alert alert-danger alert-dismissable">
                                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                                    Errore nell'inserimento dell'officina
                                </div>
                                <% } } %>
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <i class="fa fa-wrench fa-fw"></i> Aggiungi officina
                                        </div>
                                        <!-- /.panel-heading -->
                                        <div class="panel-body">
                                            <form action="MainDispatcherServlet" method="post" role="form">
                                                ...
                                                <button type="submit" value="Officina:add" name="button" class="btn btn-primary">
                                                    Aggiungi
                                                </button>
                                            </form>
                                        </div>
