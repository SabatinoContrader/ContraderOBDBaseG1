  ...
  <div id="wrapper">
    ...
    <%@ include file = "header.jsp" %>
      ...
      <div id="page-wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h1 class="page-header">Noleggia</h1>
          </div>
          <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
          ...
          <div class="col-lg-9">
            <% if (status != null) { 
              ...
              <div class="alert alert-success alert-dismissable">
                ...
                Assegnazione avventua con successo
              </div>
              <% } else if (status.equals("error")) { %>
                <div class="alert alert-danger alert-dismissable">
                  <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                  Errore nell'assegnazione dell'auto
                </div>
                <% } } %>
                  <div class="panel panel-default">
                    <div class="panel-heading">
                      <i class="fa fa-automobile fa-fw"></i> Noleggia auto
                    </div>
                    <!-- /.panel-heading -->
                    <div class="panel-body">
                      <form action="MainDispatcherServlet" method="post" role="form">
                        ...
                        <div class="form-group">
                          <label>Codice del dispositivo associato all'auto</label>
                          <input type="text" name="id_auto" class="form-control">
                        </div>
                        <button type="submit" value="Auto:addAutoDriver" name="button" class="btn btn-primary">
                          Conferma
                        </button>
                      </form>
                    </div>
