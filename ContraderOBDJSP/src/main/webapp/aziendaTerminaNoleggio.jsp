  ...
  <div id="wrapper">
    ...
    <%@ include file = "header.jsp" %>
      ...
      <div id="page-wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h1 class="page-header">Termina noleggio</h1>
          </div>
          <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
          ...
          <div class="col-lg-9">
            <% if (status != null) { 
              ...
              <div class="alert alert-success alert-dismissable">
                ...
                Noleggio terminato con successo
              </div>
                ...
                <% } } %>
                  <div class="panel panel-default">
                    <div class="panel-heading">
                      <i class="fa fa-automobile fa-fw"></i> Termina noleggio auto
                    </div>
                    <!-- /.panel-heading -->
                    <div class="panel-body">
                      <form action="MainDispatcherServlet" method="post" role="form">
                        <div class="form-group">
                          <label>Codice assocato all'auto noleggiata</label>
                          <input type="text" name="cod_dispositivo" class="form-control">
                        </div>
                        <button type="submit" value="Auto:terminaAssegnazioneAutoDriver" name="button" class="btn btn-primary">
                          Conferma
                        </button>
                      </form>
                    </div>
