...
import com.project.dao.AlertsDAO;
import com.project.dao.AziendaDAO;
import com.project.dao.CarDAO;
import com.project.dao.DispositivoDAO;
...
public class ControllerImpl implements IController {
	...
	public boolean signUpAziende(Azienda a) {
		...
		return AziendaDAO.setAzienda(a);
	}
	...
	public boolean signUpUser(String nome, String cognome, String email, String password, String telefono, int idAzienda) {
		...
		return GestioneUtenteDAO.signUp(nome, cognome, email, password, telefono, idAzienda);
	}
