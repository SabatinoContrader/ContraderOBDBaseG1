...
List<Auto> listaAutoUtente = CarDAO.getListAutoUtente(idutente);
...
<html lang="en" >
	...
	<head>
		<meta charset="utf-8" />
		<title>
			<%=a.getDenominazione()%> - Lista Auto <%=nome%> <%=cognome%>
		</title>
							...
							<div class="col-xl-12">
								<div class="m-portlet m-portlet--mobile ">
									<div class="m-portlet__head">
										<div class="m-portlet__head-caption">
											<div class="m-portlet__head-title">
												...
												<i class="fa fa-car fah3"  ></i>	Auto <%=nome%> <%=cognome%>
												</h3>
											</div>
										</div>
									...
									<tbody>
												...
												<% if(listaAutoUtente.size() != 0){

													
													NoleggioDTO clientePrivato = null;

										for(int i = 0; i<listaAutoUtente.size(); i++){


											%>
												<tr>
													<td><%=listaAutoUtente.get(i).getID()%></td>
													<td><%=listaAutoUtente.get(i).getMarca()%></td>
													<td><%=listaAutoUtente.get(i).getModello()%></td>
													<td><%=listaAutoUtente.get(i).getTarga()%></td>
													<td><%=listaAutoUtente.get(i).getNumeroTelaio()%></td>



												<%
												clientePrivato = DaoUtility.noleggioAutoClientePrivato(listaAutoUtente.get(i).getID());

												
												if(clientePrivato != null){
													if(clientePrivato.KmMaxNoleggio != 0){ %><td>In noleggio</td><%;}
													else {%><td></td><% }
