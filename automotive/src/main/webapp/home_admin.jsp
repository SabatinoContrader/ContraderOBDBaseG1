...
<html lang="en" >
	...
	<head>
		...
		<style>.savebutton{margin-left: auto;    margin-right: auto;}.btn-box{   margin-top: 20px;    width: 200px;}.logo{max-width:150px;}.m-widget24 .m-widget24__item .m-widget24__stats{margin-top:-2.43rem !important;}.m-widget24 .m-widget24__item .m-widget24__title{margin-top:1.23rem !important;}</style>
	</head>
	<!-- end::Head -->
    <!-- end::Body -->
														...
														<div class="m-dropdown__body">
															<div class="m-dropdown__content">
																<ul class="m-nav m-nav--skin-light">
																	...
																	<li class="m-nav__separator m-nav__separator--fit"></li>
																	<li class="m-nav__item">
																		<a href="index.jsp" class="btn m-btn--pill btn-secondary m-btn m-btn--custom m-btn--label-brand m-btn--bolder">
																			Logout
																		</a>
																	</li>
																</ul>
										...
										<div class="m-widget24">
											<div class="m-widget24__item">
												...
												<span class="m-widget24__desc">
													Tutte le officine del network
												</span>
												<span class="m-widget24__stats m--font-brand">
													<%=officine.size() %>
												</span>
												<div class="m--space-10"></div>
											<p style="text-align:center;"><button data-toggle="modal" data-target="#modaladdofficina" style="background-color:#716aca !important" class="btn btn-info btn-box" type="button" >Aggiungi Officina</button></p>
											</div>
										</div>
										<!--end::Total Profit-->
									</div>
									<div class="col-md-12 col-lg-6 col-xl-3">
										...
										<div class="m-widget24">
											<div class="m-widget24__item">
												...
												<br>
												<span class="m-widget24__desc">
													Tutti i clienti delle officine
												</span>
												...
												<div class="m--space-10"></div>
													...
													<p style="text-align:center;"><button data-toggle="modal" data-target="#modaladduser" style="background-color:#36a3f7  !important" class="btn btn-info btn-box" type="button" >Aggiungi Clienti</button></p>
											</div>
										</div>
										<!--end::New Feedbacks-->
									</div>
...
<div class="modal" tabindex="-1" role="dialog" id="modaladdofficina">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="nomeofficina" aria-describedby="nomeofficina" placeholder="Denominazione Officina..." name="nome" required>
   
  </div>
  <div class="form-group">
    <label for="nomereferente">Nome referente</label>
    <input type="text" class="form-control" id="nomereferente" placeholder="Nome referente..." name="nomeref">
  </div>
  <div class="form-group">
    <label for="cognomereferente">Cognome referente</label>
    <input type="text" class="form-control" id="cognomereferente" placeholder="Cognome referente..." name="cognomeref">
  </div>
    <div class="form-group">
    ...
    <input type="text" class="form-control" id="telefonoofficina" placeholder="Telefono..." name="telefonoofficina">
  </div>
   <div class="form-group">
    <label for="cittaofficina">Citt&agrave;</label>
    <input type="text" class="form-control" id="cittaofficina" placeholder="Citt&agrave;..." name="cittaofficina">
  </div>
