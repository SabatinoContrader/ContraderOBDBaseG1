...
public class AziendaController {
    ...
    @RequestMapping(value = "/countAllAzienda", method = RequestMethod.POST)
    public GenericResponse<Integer> countAllAzienda() {
        Integer countAll = (int) (long) aziendaService.countAll();
        return new GenericResponse(countAll);
    }

    @RequestMapping(value = "listAzienda", method = RequestMethod.POST)
    public GenericResponse<List<AziendaEntity>> listAzienda() {
        List<AziendaEntity> aziendaEntityList = aziendaService.findAll();
        return new GenericResponse(aziendaEntityList);
    }
