<c:choose>
    ...
    <c:when test="${sessionScope.model.user.ruolo == 3 }">
        ...
        <%@ include file = "modalAddDriver.jsp" %>
            <%@ include file = "modalNoleggio.jsp" %>
                <%@ include file = "modalTerminaNoleggio.jsp" %>
                        ...
                        <div class="panel panel-green">
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge">
                                            ${sessionScope.model.countAutoAzienda}
                                        </div>
                                        <div>Auto</div>
                                    </div>
                                </div>
                        ...
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge">
                                            ${sessionScope.model.countDriverAzienda}
                                        </div>
                                        <div>Driver</div>
                                    </div>
                                </div>
                        ...
                        <div class="panel panel-red">
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge">
                                            ${sessionScope.model.countAutoAziendaError}
                                        </div>
                                        <div>Auto</div>
                                    </div>
                                </div>
